...
- 🏢 Research Intern **@ Matsuo Institute** · Research Assistant **@ NII LLMC / LLM-jp** · Technical Trainee **@ AIST / AIRC**
...
| | Achievement | Result |
|:--|:--|:--|
| 🥈 | **Kaggle: Vesuvius Challenge – Surface Detection** — nnU-Net modeling & post-processing | Silver, **19 / 1391** |
| 🥈 | **Kaggle: CSIRO – Image2Biomass Prediction** — DINOv3-based modeling (~50 experiments) | Silver, **133 / 3802** |
