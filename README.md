...
[![Hugging Face](https://img.shields.io/badge/HuggingFace-FFD21E?style=for-the-badge&logo=huggingface&logoColor=black)](https://huggingface.co/Ta1k1)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/TaikiMetoki)

![Profile Views](https://komarev.com/ghpvc/?username=T41K1&color=70A5FD&style=flat-square&label=Profile+Views)
...
AI創薬・医用画像・LLM post-training を主軸に、**研究と実装の両方**に取り組む修士課程の学生です。大学・研究機関・スタートアップでの研究開発インターンを通じて、バイオインフォマティクス／データサイエンス／強化学習を実務と研究の両面で経験しています。

- 🔬 **Research focus** — AI Drug Discovery, Medical Imaging, LLM Post-training (RL / reasoning)
- 🏢 **Currently** — 産業技術総合研究所 (AI創薬) ・ LLM-jp (RA / LLM post-training) ・ 松尾研究所
- 🥈 **Kaggle Competition Expert** — Silver Medal × 2
- 🎯 **Goal** — Kaggle Master / 実世界で効く AI を作る
...
| | Achievement | Result |
|:--|:--|:--|
| 🥈 | **Kaggle: Vesuvius Challenge – Surface Detection** — nnU-Net によるモデル開発・後処理 | Silver, **19 / 1391** |
| 🥈 | **Kaggle: CSIRO – Image2Biomass Prediction** — DINOv3 ベースのモデル開発（約50実験） | Silver, **133 / 3802** |
...
![HPC](https://img.shields.io/badge/HPC%2FSLURM-0078D4?style=for-the-badge&logo=supermicro&logoColor=white)
...
![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=T41K1&theme=tokyo-night&hide_border=true&area=true)
...
![github contribution snake](https://raw.githubusercontent.com/T41K1/T41K1/output/github-contribution-grid-snake-dark.svg)
